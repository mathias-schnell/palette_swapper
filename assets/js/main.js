...
const toolbar_actions = {
    ...
    zoom_in                 : () => { ui.zoom_image(0.25); app.set_new_base_image(true); },
    zoom_out                : () => { ui.zoom_image(-0.25); app.set_new_base_image(true); },
    load_source             : () => ui_cache.upload_source.click(),
    load_palette            : () => ui_cache.upload_palette.click(),
    flip_h                  : () => { ui.flip_image_horizontal(); app.set_new_base_image(true); },
    flip_v                  : () => { ui.flip_image_vertical(); app.set_new_base_image(true); },
    rotate_90cw             : () => { ui.rotate_image(90); app.set_new_base_image(true); },
    rotate_90ccw            : () => { ui.rotate_image(-90); app.set_new_base_image(true); },
    rotate_180              : () => { ui.rotate_image(180); app.set_new_base_image(true); },
